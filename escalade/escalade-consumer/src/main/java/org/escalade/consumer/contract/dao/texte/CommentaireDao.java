...
public interface CommentaireDao {
	...
	/**
	 * Enregistre le commentaire dans la base de données et retourne le commentaire
	 * modifié (avec son identifiant dans la base de donnée)
	 * 
	 * @param spotId
	 * @param commentaire
	 * @return Commentaire
	...
	/**
	 * Supprime de la base de données les commentaires du spot à partir de son
	 * identifiant
	 * 
	 * @param spotId
	 */
