...
public class SpotRM implements RowMapper<Spot> {
	...
	public Spot mapRow(ResultSet pRS, int pRowNum) throws SQLException {
		...
		Spot spot = new Spot(id, nom, ouvert, adapteEnfants, latitude, longitude, ville, nbSecteur, hauteurMax,
				hauteurMin, nbVoie, difficulteMin, difficulteMax, auteur, presentation);
